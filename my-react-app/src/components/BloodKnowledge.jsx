    ...
    <>
      ...
      <main className="blood-knowledge-container">
        ...
        <section className="blood-section">
          <h3>Các Nhóm Máu</h3>
          <figure>
            <img src="/tebaomau3.webp" alt="Tế bào máu" className="blood-img"/>
            <figcaption className="blood-caption">Tế bào máu.
</figcaption>
            </figure>
          <ul>
            <li><b>Nhóm máu A</b>: Có kháng nguyên A trên bề mặt hồng cầu.</li>
            <li><b>Nhóm máu B</b>: Có kháng nguyên B trên bề mặt hồng cầu.</li>
            <li><b>Nhóm máu AB</b>: Có cả kháng nguyên A và B.</li>
            <li><b>Nhóm máu O</b>: Không có kháng nguyên A, B.</li>
          </ul>
          <p>
Trong máu có chất gì?
Thành phần của máu bao gồm huyết cầu (hồng cầu, bạch cầu, tiểu cầu) và huyết tương. Thành phần của huyết tương chủ yếu là nước (chiếm đến 92%) và các chất quan trọng khác như:
...
Vitamin          </p>
        ...
        <section className="blood-section">
          ...
          <figure>
            <img src="/hongcau.webp" alt="Hồng cầu" className="blood-img"/>
            <figcaption className="blood-caption">Hồng cầu chiếm số lượng nhiều nhất trong số các loại tế bào máu.
</figcaption>
            </figure>
          <p>
...
Trung bình hồng cầu chỉ tồn tại được 120 ngày. Hồng cầu già bị tiêu hủy chủ yếu ở lách và gan. Tủy xương sản sinh các hồng cầu mới để thay thế và duy trì lượng hồng cầu ổn định trong cơ thể          </p>
        </section>
        <section className="blood-section">
          <h3>Bạch Cầu (White Blood Cells)</h3>
          <figure>
            <img src="/bachcau.jpg" alt="Bạch cầu" className="blood-img"/>
            <figcaption className="blood-caption">Tế bào bạch cầu chỉ chiếm khoảng 1% tổng lượng máu.
...
Tế bào bạch cầu trong máu là một phần quan trọng của hệ thống miễn dịch tự nhiên của cơ thể nhưng chỉ chiếm khoảng 1% tổng lượng máu. Số lượng bạch cầu trong một microlit máu thường dao động từ 3.700 -10.500/µL. Số lượng bạch cầu cao hơn hoặc thấp hơn so với lượng trung bình có thể là dấu hiệu của một bệnh lý nào đó.
          ...
          <ul> Chức năng chính của bạch cầu bao gồm:
            <li>Chống lại các loại vi trùng khác nhau như vi khuẩn, virus</li>
            <li>Tạo kháng thể, là những protein đặc biệt có khả năng nhận biết và loại bỏ các vật thể lạ, có hại (như tế bào chết, mảnh vụn mô và tế bào hồng cầu cũ,…)</li>
            <li>Bảo vệ cơ thể khỏi các vật thể lạ xâm nhập vào máu như các chất gây dị ứng</li>
...
Thời gian tồn tại của bạch cầu thay đổi từ vài giờ đến nhiều năm. Các tế bào bạch cầu mới liên tục được hình thành – một số ở tủy xương và một số ở các bộ phận khác của cơ thể như lá lách, tuyến ức và các hạch bạch huyết.
            ...
            <ul> Các loại tế bào bạch cầu bao gồm:
            <li>Tế bào lympho</li>
 ...
 <figure>
            <img src="/huyetuong.jpg" alt="Huyết Tương" className="blood-img"/>
            <figcaption className="blood-caption">Huyết Tương.
</figcaption>
            </figure>          <p>
...
Huyết tương có chức năng vận chuyển các tế bào máu đi khắp cơ thể cùng với các chất dinh dưỡng, chất thải, kháng thể, protein đông máu, chất truyền tin hóa học như hormone và protein giúp duy trì cân bằng chất lỏng của cơ thể.
...
Protein huyết tương chủ yếu là albumin, một phân tử tương đối nhỏ có chức năng chính là giữ nước trong máu nhờ tác dụng thẩm thấu. Lượng albumin trong máu là yếu tố quyết định tổng thể tích huyết tương. Sự suy giảm albumin làm cho chất lỏng rời khỏi tuần hoàn và tích tụ, gây sưng mô mềm (phù nề). Albumin liên kết với một số chất khác được vận chuyển trong huyết tương nên đóng vai trò là protein vận chuyển không đặc hiệu.          </p>
        </section>
        <section className="blood-section">
          <h3>Tiểu Cầu (Platelets)</h3>
<figure>
            <img src="/tieucau.png" alt="Tiểu cầu" className="blood-img"/>
            <figcaption className="blood-caption">Tiểu cầu.
</figcaption>
            </figure>            <p>
...
Tuy nhiên, cần lưu ý số lượng tiểu cầu cao hơn bình thường có thể gây đông máu không cần thiết, dẫn đến những cơn đau tim và đột quỵ. Ngược lại, số lượng tiểu cầu thấp hơn bình thường có thể dẫn đến chảy máu nhiều, khó cầm máu.          </p>
        </section>
